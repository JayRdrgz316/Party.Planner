document.addEventListener("DOMContentLoaded", () => {
    ...
    function addPartyToList(party) {
        ...
        deleteButton.addEventListener("click", () => {
            ...
            fetch(`https://fsa-crud-2aa9294fe819.herokuapp.com/api/2310-FSA-ET-WEB-PT-SF-B-jorge/events/${partyId}`, {
                method: "DELETE"
            })
            .then(response => {
                if (response.ok) {
...
function fetchParties() {
    fetch('https://fsa-crud-2aa9294fe819.herokuapp.com/api/2310-FSA-ET-WEB-PT-SF-B-jorge/events')
